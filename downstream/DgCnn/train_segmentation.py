...
from utils import copy_parameters, calculate_sem_IoU
...
def parse_args():
    ...
    parser.add_argument('--log_dir', type=str, default='results_segmentation', metavar='N',
    ...
    parser.add_argument('--batch_size', type=int, default=32, metavar='batch_size',
                        help='Size of batch)')
    parser.add_argument('--nepoch', type=int, default=100, metavar='N',
