...
def parse_args():
    ...
    parser.add_argument('--log_dir', type=str, default='results_cls', metavar='N',
    ...
    parser.add_argument('--batch_size', type=int, default=32, metavar='batch_size',
                        help='Size of batch)')
    parser.add_argument('--nepoch', type=int, default=250, metavar='N',
    ...
    parser.add_argument('--ratio', type=int, default=1, metavar='S',
                        help='random seed (default: None)')
...
def train():
    ...
    if args.dataset_type == 'modelnet40' or args.dataset_type == 'modelnet40_60' or args.dataset_type == 'modelnet40_70' or args.dataset_type == 'modelnet40_80' or args.dataset_type == 'modelnet40_90':
    ...
    elif args.dataset_type == 'modelnet40_10' or args.dataset_type == 'modelnet40_20' or args.dataset_type == 'modelnet40_50' or args.dataset_type == 'modelnet40_5':
        dataset = ModelNetDataset(
            root=args.dataset_path,
            npoints=args.num_point,
            split='train',
    ...
    for epoch in range(1,args.nepoch+1):
        ...
        print('[%d] train loss: %f accuracy: %f test_acc: %f best acc: %f best epoch: %d' % (epoch, total_loss/total_point,train_acc,test_acc,best_acc, best_epoch))
