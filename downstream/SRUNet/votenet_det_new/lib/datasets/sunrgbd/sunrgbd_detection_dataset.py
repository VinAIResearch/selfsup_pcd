...
class SunrgbdDetectionVotesDataset(Dataset):
    def __init__(
        ...
        self.use_v1 = use_v1
        if use_v1:
            self.data_path = os.path.join(ROOT_DIR, "sunrgbd/sunrgbd_pc_bbox_votes_50k_v1_%s" % (split_set))
        else:
            self.data_path = os.path.join(ROOT_DIR, "sunrgbd/sunrgbd_pc_bbox_votes_50k_v2_%s" % (split_set))
