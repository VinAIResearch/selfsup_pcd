...
class SunrgbdDetectionVotesDataset(Dataset):
    def __init__(self, split_set='train', num_points=20000,
        ...
        augment=False, scan_idx_list=None, data_ratio=1.0, test_phase=False):
    ...
    def __getitem__(self, idx):
        ...
        point_cloud, choices = pc_util.random_sampling(point_cloud, self.num_points, return_choices=True, fixseed=self.test_phase)
