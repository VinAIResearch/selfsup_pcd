    ...
    def __init__(
        ...
        if backbone == "pointnet2":
            ...
            self.backbone_net = SparseConvBackbone(
                input_feature_dim=self.input_feature_dim + 3, output_feature_dim=256, num_seed=1024
            )
    ...
    def forward(self, inputs):
        ...
        if self.backbone == "pointnet2":
            ...
            end_points = self.backbone_net(
                inputs["point_clouds"], inputs["voxel_coords"], inputs["voxel_feats"], inputs["voxel_inds"], end_points
            )
...
if __name__ == "__main__":
    ...
    from loss_helper import get_loss
    from sunrgbd_detection_dataset import DC, SunrgbdDetectionVotesDataset
