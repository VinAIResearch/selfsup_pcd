...
class Voxelizer:
    ...
    def voxelize(self, coords, feats, labels, center=None):
        #     print("Check lib/voxelizer 1__________" , type(coords))
        ...
        #     print("Check lib/voxelizer 2________" , type(coords))
        ...
        #     print("Check lib/voxelizer 3________" , type(coords_aug))
        ...
        #     print("Check lib/voxelizer 4________" , type(coords_aug))
        ...
        #     print("Check lib/voxelizer 5________" , type(coords_aug), type(feats), type(labels))
        return coords_aug.numpy(), feats, labels, rigid_transformation.flatten()


def test():
    N = 16575
    coords = np.random.randn(N, 3) * 100
    print(coords)
    ...
    labels[:3] = 2
    voxelizer = Voxelizer()
    temp = voxelizer.voxelize(coords, feats, labels)
    print(np.max(temp[0]), np.min(temp[0]))
