...
class VoxelizationDataset(VoxelizationDatasetBase):
    ...
    def __getitem__(self, index):
        ...
        #     print("Check lib/dataset 1" , type(coords))
        ...
        #     print("Check lib/dataset 2" , type(coords))

        #   get
        # print('Before voxelized: ',np.max(coords), np.min(coords))
        coords, feats, labels, transformation = self.voxelizer.voxelize(coords, feats, labels, center=center)
        # print('After voxelized: ',np.max(coords), np.min(coords))
        #     print("Check lib/dataset 3" , type(coords))
        ...
        #     print("Check lib/dataset 4", type(coords))
...
def initialize_data_loader(
    ...
    if repeat:
        if get_world_size() > 1:
            data_args["sampler"] = DistributedInfSampler(
