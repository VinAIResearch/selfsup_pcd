...
from data_utils import normalize_point_cloud, rotate_point_cloud, jitter_point_cloud, center_point_cloud, farthest_pair_sample, separate_point_sample,translate_pointcloud
test_transform = transforms.Compose([
    transforms.ToTensor()])
list_error = ['airplane_0299.', 'plant_0116.','curtain_0071.', 'tv_stand_0055.', 'tv_stand_0012.', 'bottle_0064.', 'bottle_0296.', 'bottle_0106.', 'bottle_0154.', 'bottle_0149.', 'bottle_0036.', 'radio_0019.', 'guitar_0045.', 'guitar_0109.', 'flower_pot_0110.', 'cup_0058.', 'vase_0354.', 'keyboard_0088.']
...
class ModelNetSSL_MVDataset(data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        point_set = torch.from_numpy(point_set.astype(np.float32))
        return point_set, torch.cat(list_image, dim=0)
    def __len__(self):
        return len(self.paths)
